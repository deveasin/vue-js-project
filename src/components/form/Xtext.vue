<template>
    <ValidationProvider :name="data.title" :rules="rules" v-slot="{ errors }">
        <div class="form-group">
            ...
            <input :name="name" class="form-control" :class="errors.length ? 'error' : ''" type="text" v-model="data.value" v-bind="data.html_attr ? data.html_attr : ''" v-bind:readonly="data.readonly">
